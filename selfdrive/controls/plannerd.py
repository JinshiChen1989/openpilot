...
from openpilot.selfdrive.controls.lib.nagaspilot.lateral_planner import LateralPlanner
...
def main():
  ...
  pm = messaging.PubMaster(['longitudinalPlan', 'longitudinalPlanSP', 'uiPlan', 'driverAssistance'] + lateral_planner_svs)
  ...
  # ACM flags removed - now handled by DCP system
  np_flags = 0
  while True:
    sm.update()
    if sm.updated['modelV2']:
      ...
      longitudinal_planner.update(sm, np_flags)
