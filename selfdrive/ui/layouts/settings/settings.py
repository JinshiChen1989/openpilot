...
from openpilot.selfdrive.ui.layouts.settings.nagaspilot import NagasPilotLayout
...
class SettingsLayout:
  def __init__(self):
    ...
    self._panels = {
      ...
      PanelType.NAGASPILOT: PanelInfo("NagasPilot", NagasPilotLayout(), rl.Rectangle(0, 0, 0, 0)),
    }
