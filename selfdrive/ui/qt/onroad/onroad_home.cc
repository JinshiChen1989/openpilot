...
void OnroadWindow::updateDpIndicatorStates(const UIState &s) {
  ...
  updateDpIndicatorSideState(cs.getLeftBlinker(), cs.getLeftBlindspot(), np_indicator_show_left, np_indicator_show_left_prev, np_indicator_count_left, np_indicator_color_left);
  updateDpIndicatorSideState(cs.getRightBlinker(), cs.getRightBlindspot(), np_indicator_show_right, np_indicator_show_right_prev, np_indicator_count_right, np_indicator_color_right);
}
